...
(async function fetchData(dataArray = []) {
    ...
    const urlArray = [
      'https://api.openweathermap.org/data/2.5/weather?q=London,uk&APPID=da8d194efc9c8d178de8ca27774fe10e',
      'https://api.openweathermap.org/data/2.5/weather?q=Houston&APPID=da8d194efc9c8d178de8ca27774fe10e',
      'https://api.openweathermap.org/data/2.5/weather?q=Lisbon&APPID=da8d194efc9c8d178de8ca27774fe10e',
      'https://api.openweathermap.org/data/2.5/weather?q=Baltimore&APPID=da8d194efc9c8d178de8ca27774fe10e',
    ];
    ...
    urlArray.forEach(async (url) => {
      makeRequest(url).then(function (result) {
        ...
        if (dataArray.length == urlArray.length) {
          ...
          // Recorrer cada array del objeto y parsear solo el que contiene el nombre Lisboa en su array
          dataArray.forEach(elem => {
            if (JSON.parse(elem).name == "Lisbon"){
              addLisbonDataToDocument(elem, dataArray)
            }
          })
